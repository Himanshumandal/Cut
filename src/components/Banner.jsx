...
const BannerHome = () => {
  const bannerData = useSelector((state) => state.filmaData.bannerData);
            ...
            >
              ...
              <div className="container mx-auto">
                <div className=" w-full absolute bottom-0 max-w-md px-3">
                  ...
                  <button className=" bg-white my-3 px-4 py-2 text-black font-bold rounded mt-4  hover:bg-gradient-to-l from-red-700 to-orange-500 shadow-md transition-all hover:scale-105">
                    Play Now
                  </button>
                  </Link>
                </div>
